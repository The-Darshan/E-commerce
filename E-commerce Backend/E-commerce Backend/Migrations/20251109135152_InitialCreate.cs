    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductUser", x => new { x.PurchasedById, x.PurchasedProductsId });
                    table.ForeignKey(
                        name: "FK_ProductUser_Products_PurchasedProductsId",
                        column: x => x.PurchasedProductsId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductUser_Users_PurchasedById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductUser_PurchasedProductsId",
                table: "ProductUser",
